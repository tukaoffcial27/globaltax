...
"[project]/app/dashboard/lab/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function IntelligenceLab() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IntelligenceLab.useEffect": ()=>{
            const checkAccess = {
                "IntelligenceLab.useEffect.checkAccess": async ()=>{
                    ...
                    if (user) {
                        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('is_pro').eq('id', user.id).single();
                        if (data) setIsPro(data.is_pro);
                    }
                    setLoading(false);
                }
            }["IntelligenceLab.useEffect.checkAccess"];
            checkAccess();
        }
    }["IntelligenceLab.useEffect"], []);
...
_s(IntelligenceLab, "McxbDlh3bkhokAA04q5hyRr2VAg=");
_c = IntelligenceLab;
var _c;
__turbopack_context__.k.register(_c, "IntelligenceLab");
...
//# sourceMappingURL=_ff4f82e2._.js.map
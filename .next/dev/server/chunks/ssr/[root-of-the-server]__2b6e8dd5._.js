...
// Pastikan import menggunakan 'lucide-react' (bukan lucide-center yang menyebabkan error sebelumnya)
...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            // 2. Ambil data profil untuk cek status Pro
            if (user) {
                const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('is_pro').eq('id', user.id).single();
                if (profileError) throw profileError;
                // 3. Logika Redireksi: Jika Pro ke Intelligence, Jika Standar ke Dashboard
                if (profile?.is_pro) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b6e8dd5._.js.map